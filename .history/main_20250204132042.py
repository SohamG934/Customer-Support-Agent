...
def send_grievance_email(user_email, grievance_summary):
    ...
    receiver_email = "official@company.com"
    ...
    with smtplib.SMTP("smtp.company.com", 587) as server:
        server.starttls()
        server.login(sender_email, "your-password")  # Securely handle credentials
...
# Greeting message
greeting = st.empty()
greeting.text("Hello! How may I assist you today?")

# Select language
language = st.selectbox("Select your language:", ["English", "Spanish", "French", "German", "Chinese"])
...
prompt_template = PromptTemplate(
    ...
    template="You are a helpful customer support assistant. Respond in {language}. Context: {chat_history}. User's question: {question}."
)
