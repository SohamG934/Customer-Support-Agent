...
chain = ConversationalRetrievalChain.from_llm(llm, vectorstore.as_retriever(), combine_docs_chain_kwargs={"prompt": prompt_template})
...
if user_input:
    ...
    response = chain.run({"question": user_input, "chat_history": context, "language": language})
