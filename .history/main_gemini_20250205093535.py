...
genai.configure(api_key="AIzaSyCDpsMYoyfbaPbzuRA_7f8S5nDJqJ2Rl7w")
...
if user_input:
    ...
    response = chat_session.send_message(f"Please follow the system instructions for the following query. User's question: {user_input}", role="user")
